...
('Как правильно медитировать', 'Пошаговое руководство для начинающих. Личный опыт и советы.', 'https://example.com/images/meditation.jpg', 10, 'Мастер медитации', 'https://example.com/avatars/meditation1.jpg', '2023-02-10 08:30:00', false),
